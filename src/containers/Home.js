...
const FooterComponent = () => (
    <div style={{ width: '100%', backgroundColor: '#4D5656', paddingTop: '10px'}}>
        ...
        <p style={{ color: 'black', textAlign: 'center', color: 'white', fontFamily: 'Playfair Display' }}> copyright &copy; 2018 All Rights Reserved</p><p style={{ color: 'black', textAlign: 'center', color: 'white', fontFamily: 'Playfair Display' }}>Contact information: 8456451447 <a href="mailto:ziyandaayd@gmail.com" class="footerLink">
